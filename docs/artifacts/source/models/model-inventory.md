...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `sh-system-context` | context | c4 | system-modeler | `docs/artifacts/source/models/sh-system-context.md` | `cmd/skill-harness/main.go`, `scripts/dependencies.json`, `scripts/agent_loadouts.json`, `scripts/external_skill_intake.py`, `scripts/check_external_skill_intake.py`, `packs/`, `README.md`, `docs/developer-artifacts.md`, `docs/agent-operating-skills.md`, `docs/third-party-skill-intake.md` | `AGENTS.md`, `scripts/dependencies.json`, `scripts/agent_loadouts.json`, `tests/fixtures/external-skill-intake/` | `generated/review/models/sh-system-context.html` |
...
| 2026-06-19 | Added external agentic ecosystem intake scanner, fixtures, and operating-skill adoption surfaces. | `docs/third-party-skill-intake.md`, `scripts/external_skill_intake.py`, `tests/fixtures/external-skill-intake/` |
